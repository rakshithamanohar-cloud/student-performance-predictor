...
## What I Found
Family income turned out to be the biggest predictor of student success (19.42%), more than study hours or attendance. It made me realize that socio-economic background plays a bigger role in academic performance than effort alone.
...
## What I Learned
- Real datasets don't always give clean results and that's okay
- Feature importance matters more than just accuracy
- Data imbalance affects model predictions a lot
- How to deploy a machine learning app using Streamlit
